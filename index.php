  ...
  <table id="dt" class="table align-middle cell-border hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
            <img src="img/<?php echo $result['foto_siswa']; ?>" alt="Mouse" style="width: 100px;">
        </td>
        ...
        <td>
            ...
            <a href="proses.php?hapus=<?php echo $result['id_siswa']; ?>"    type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah Anda yakin ingin menghapusnya???')">
